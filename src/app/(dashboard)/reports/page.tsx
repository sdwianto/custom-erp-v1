  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Dashboard Views</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Comprehensive reporting and analytics system for CA Mine business intelligence.
          </p>
        </CardContent>
      </Card>
    </div>
